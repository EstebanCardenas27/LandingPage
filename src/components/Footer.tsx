    ...
    <footer className="bg-[#3d3229] text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-lg">Mi Cabaña Rural</h3>
              </div>
              <p className="text-sm text-gray-300">
                Disfruta de la tranquilidad y belleza del campo en nuestra acogedora cabaña rural.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
            <p>© {new Date().getFullYear()} Mi Cabaña Rural. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
  )
